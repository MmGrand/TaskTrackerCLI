...
Ошибки выводятся в stderr. Коды выхода:

| Код | Когда |
| --- | --- |
| `0` | Успех, в том числе `help` |
| `1` | Ошибка выполнения: задача не найдена, пустое описание, проблема с файлом |
| `2` | Неверный вызов: неизвестная команда, неверное число аргументов |
